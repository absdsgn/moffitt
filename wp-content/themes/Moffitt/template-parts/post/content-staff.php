...
<div class="moffitt-team-item">
	...
	<div class="moffitt-team-modal-wrapper">
		<div class="moffitt-team-modal-content">
			...
			<i class="fas fa-phone" style="color: #a0a0a0; font-size: .75rem; margin-right: .75rem;"></i><a href="tel:<?php the_field('phone');?>,<?php the_field('extension');?>"><?php the_field('phone');?>x<?php the_field('extension');?></a><br>
			<i class="fas fa-envelope" style="color: #a0a0a0; font-size: .75rem; margin-right: .75rem;"></i><a href="mailto:<?php the_field('email'); ?>"><?php the_field('email'); ?></a>
